         ...
         <div class="contain py-16">
            <div class="max-w-lg mx-auto shadow px-6 py-7 rounded overflow-hidden bg-[#333]">
               ...
               <form action="#" method="post" autocomplete="off">
                  <div class="space-y-2">
                     <div>
                        <label for="name" class="text-white-600 mb-2 block">Full Name</label>
                     ...
                     <div>
                        <label for="confirm" class="text-white-600 mb-2 block">Confirm password</label>
                  ...
                  <div class="mt-6">
                     <div class="flex items-center">
                        ...
                        <label for="aggrement" class="text-white-600 ml-3 cursor-pointer">I have read and agree to the <Link
                           href="#" class="text-primary">terms & conditions</Link></label>
                     </div>
                  </div>
                  <div class="mt-4">
                     <button type="submit"
               ...
               <div class="mt-6 flex justify-center relative hidden">
                  <div class="text-white-600 uppercase px-3 bg-white z-10 relative">Or signup with</div>
               ...
               <p class="mt-4 text-center text-white-600">Already have account?
                  <Link to="/login"
                     class="text-primary">
                     Login now
                  </Link>
